...
<div class="container">
    <div class="row justify-content-center font-italic">
        <div class="col-9 col-sm-8 col-md-5 col-lg-4 col-xl-4">
            ...
            @if( !Session::get('success') )
            <form class="text-center" action="{{ route('preregister.send-form', ['locale'=>app()->getLocale()]) }}" method="POST">
                @csrf
                ...
                <div class="form-group mt-1">
                    <div class="custom-control custom-checkbox small">
                        ...
                        <label class="custom-control-label" for="politics">@lang('preregister.politica', ['urlLegal'=>route('preregister.legal', ['locale'=>app()->getLocale()])])</label>
                    </div>
