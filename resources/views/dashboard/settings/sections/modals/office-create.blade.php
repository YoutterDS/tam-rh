{{-- Editing Offices --}}
<div class="modal fade" id="modalOfficeCreate" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase" id="exampleModalLabel">Crear Oficina</h5>
...
{{--                    </div>--}}
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control" id="officeCity" placeholder="Ciudad de la oficina">
                        </div>
                        <div class="form-row">
                            <label for="officePc">Código Postal</label>
                            <input type="text" class="form-control" id="officePc" placeholder="Código postal de la oficina">
                        </div>
                        <div class="form-row">
                            <label for="officeProvince">Estado/Provincia/Región</label>
                            <input type="text" class="form-control" id="officeProvince" placeholder="Estado/Provincia/Región">
                        </div>
                        <div class="form-row">
