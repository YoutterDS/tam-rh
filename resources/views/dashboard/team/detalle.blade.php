...
@section('content')
    <div class="row">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-uppercase">Editar - Ramon Ribera</h1>
        </div>
                ...
                <form>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="infoPositionInput" aria-describedby="emailHelp" value="Manager"
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="infoSalaryInput" class="form-control" placeholder="Salario bruto anual" value="25.000">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="infoIbanInput">Número de cuenta bancaria (IBAN)</label>
                            <input type="text" class="form-control" id="infoIbanInput"
                                   placeholder="Número de cuenta bancaria" value="ES5504877639949951451996">
                        </div>
                    </div>
                    <ul>
                        <li>
