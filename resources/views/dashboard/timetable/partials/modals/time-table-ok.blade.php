        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <ul style="list-style: none;padding: 0;">
                    <li><span><i class="fas fa-user" style="color: #1d68a7;"></i> <strong
                                class="text-uppercase">RAMON RIBERA</strong> / Manager</span></li>
                    <li><i class="far fa-calendar-alt" style="color: #1d68a7;"></i> <strong class="text-uppercase">Fecha inicio</strong> 1/06/2020
                    </li>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary text-uppercase"><i class="fas fa-file-excel" onclick="alert('Exportar registro');"></i>
                    Exportar registro
                </button>
            </div>
        </div>
